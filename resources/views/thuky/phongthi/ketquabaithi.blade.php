					...
					<tr>
						...
						<td class="small"><span style="color:#0000ff;font-weight:bold;">{{ $value->holot }} {{ $value->ten }}</span>
							<span style="font-size:0.9em;">
								...
								<a href="#hinhanh" class="fw-bold" onclick="getXemHinh('{{ $value->duongdan }}')"><i class="fas fa-eye"></i> Xem lại bài làm</a><br>
								<a href="#taiZip" class="fw-bold" onclick="event.preventDefault();getZip('{{$value->masinhvien}}','{{$value->duongdan}}');
