                    ...
                    <div class="price-item">
                        ...
                        <div class="p-4 pt-0">
                            @foreach($hoidongthi_phongthi_ds as $value1)
                              ...
                              @endif
                            @endforeach
                            <a class="btn-slide mt-2" href="{{ route('thuky.phongthi',['phongthi_id'=>$value->phongthi_id]) }}" class="btn btn-primary"><i class="fa fa-arrow-right"></i><span >Vào phòng</span></a>
                            </a>
