...
<div class="pagetitle">
  ...
  <nav>
	<ol class="breadcrumb">
	  ...
	  <li class="breadcrumb-item"><a href="{{route('hoidongthi.qldethi.danhsach')}}">Quản lý đề thi</a></li>
...
<section class="section">
  <div class="row">
    ...
    <!--Thêm mới-->
<form action="{{route('hoidongthi.qldulieudethi.themmoi',['dethi_id' => $ktdethi->id])}}" method="post">
		@csrf
	...
	<form action="{{ route('hoidongthi.qldulieudethi.sua') }}" method="post">
		@csrf
	...
	<form action="{{ route('hoidongthi.qldulieudethi.xoa') }}" method="post">
		@csrf
