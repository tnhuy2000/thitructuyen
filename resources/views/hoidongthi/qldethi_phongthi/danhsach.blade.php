...
<section class="section">
  <div class="row">
    ...
    <!--Thêm mới-->
<form action="{{route('hoidongthi.qldethi_phongthi.them',['phongthi_id'=> $ktphongthi->id])}}" method="post">
		@csrf
	...
	<!--Sửa ghi chú-->
	<form action="{{route('hoidongthi.qldethi_phongthi.sua')}}" method="post">
		@csrf
...
<form action="{{ route('hoidongthi.qldethi_phongthi.xoa') }}" method="post">
		@csrf
