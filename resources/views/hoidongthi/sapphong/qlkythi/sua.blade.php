...
<div class="pagetitle">
  ...
  <nav>
    ...
    <li class="breadcrumb-item">Sắp phòng thi</li>
	  <li class="breadcrumb-item"><a href="{{route('hoidongthi.qlkythi.danhsach')}}">Quản lý kỳ thi</a></li>
  ...
  <div class="row">
	<div class="col-lg-12">
      ...
      <div class="card-body">
              ...
              <form action="{{ route('hoidongthi.qlkythi.sua', ['id' => $ktkythi->id]) }}" method="post" class="row g-3 needs-validation" novalidate>
                    @csrf
                    <div class="col-md-4">
