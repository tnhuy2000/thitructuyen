...
<div class="pagetitle">
  ...
  <nav>
    ...
    <li class="breadcrumb-item"><a href="{{route('hoidongthi.qlcathi.danhsach')}}">Quản lý ca thi</a></li>
  ...
  <div class="row">
	<div class="col-lg-12">
      ...
      <div class="card-body">
              ...
              <form action="{{ route('hoidongthi.qlcathi.sua', ['id' => $ktcathi->id]) }}" method="post" class="row g-3 needs-validation" novalidate>
                    @csrf
