  ...
  <div class="container-xxl">
        <div class="container py-3">
            ...
            <h5><img src="{{asset('public/img/lambai.png')}}" width="50px" alt="">
                @if($dem==1)
                <a href="{{route('canbocoithi.dethi',['phongthi_id'=>$hoidongthi_phongthi->phongthi_id])}}" > 2. Làm bài thi <i class="fas fa-chevron-circle-right"></i></a>
                @else
            ...
            <h5>
                ...
                <a  href="{{route('canbocoithi.danhsachthisinh',['phongthi_id'=>$hoidongthi_phongthi->phongthi_id])}}" > 3. Giám thị điểm danh thí sinh <i class="fas fa-chevron-circle-right"></i></a>
               
            </h5>
            <h5><a href="{{route('canbocoithi.ketquabaithi',['phongthi_id'=>$hoidongthi_phongthi->phongthi_id])}}" class="btn btn-primary col-sm-12 col-md-4"> <i class="fas fa-clipboard-list"></i> Kết quả làm bài</a></h5>
            </div>
            <div class="col-sm-3"></div>
            </div>
            

    <form action="{{route('canbocoithi.chondethi')}}" method="post">
		@csrf
