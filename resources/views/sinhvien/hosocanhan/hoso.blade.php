            ...
            <div class="row g-4">
                ...
                <div class="col-md-3">
                    <div class="team-item p-4">
                        ...
                        <h6 class="text-muted text-center">Sinh viên</h6>
                                ...
                                <div class="tab-content pt-2" id="borderedTabJustifiedContent">
                                    <div class="tab-pane fade show active" id="bordered-justified-profile"
                                        ...
                                        <form class="form-horizontal" method="POST"
                                            action="{{ route('sinhvien.sinhvienUpdateInfo') }}" id="InfoForm">
                                            @csrf
                                            <h4>Thông tin tài khoản</h4>
                                            <div class="form-group row">
                                                <label for="inputName" class="col-sm-2 form-label">Tên hiển thị</label>
                                                <div class="col-sm-10">
                                                    ...
                                                    <div class="form-group row mt-2">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" id="inputPhone"
                                                                ...
                                                                value="{{ $sinhvien->dienthoai }}" name="dienthoai">
                                                            <span class="text-danger error-text dienthoai_error"></span>
                                                       
                                                        </div>
                                                    </div>
                                                @endif
                                                @if (!empty($sinhvien->malop))
                                                    <div class="form-group row mt-2">
                                                        <label for="inputName" class="col-sm-2 form-label">Lớp</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" id="" readonly
                                                                value="{{ $sinhvien->malop }}">


                                                        </div>
                                                    </div>
                                                @endif
                                                @if (!empty($sinhvien->tenkhoa))
                                                    <div class="form-group row mt-2">
                                                        <label for="inputName" class="col-sm-2 form-label">Khoa</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" id="" readonly
                                                                value="{{ $sinhvien->tenkhoa }}">
                                    ...
                                    <div class="tab-pane fade" id="bordered-justified-changepassword" role="tabpanel"
                                        ...
                                        <form class="form-horizontal" action="{{ route('sinhvien.sinhvienChangePassword')}}" method="POST" id="changePasswordForm">
                                          @csrf
                                          <h4>Đổi mật khẩu</h4>
                                            <div class="form-group row mt-2">
  ...
  <script type="text/javascript">
      ...
      $(function() {
          ...
          $('#user_image').ijaboCropTool({
              ...
              processUrl: '{{ route('sinhvien.sinhvienPictureUpdate') }}',
