			...
			<div class="col-md-8">
				<div class="card" style="border-width: 5px;border: solid;">
					...
					<div class="card-body text-center">
						...
						<div class="bg-light text-center py-2 px-2" style="border: dashed;">
						<!-- End Table with stripped rows -->
							<form role="form" method="post" action="{{route('sinhvien.nopbai.them')}}" id="form_exam_submit" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<div class="input-group">
										<div class="input-group-prepend">
											<div class="input-group-text" id="ChonHinh"><a href="#hinhanh">Chọn file</a></div>
										</div>
								...
								<br>
								<button type="submit" class="btn btn-primary"><i class="fas fa-upload"></i> Làm xong</button>
