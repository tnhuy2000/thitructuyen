...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <i class="bi bi-list toggle-sidebar-btn"></i>
      <a href="{{route('hoidongthi.dashboard')}}" class="logo d-flex align-items-center">
        <img src="{{asset('public/themes/img/logo.png')}}" alt="">
        <span class="d-none d-lg-block text-white">Online Exam</span>
      </a>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="{{route('hoidongthi.dashboard')}}">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{route('hoidongthi.qlkythi.danhsach')}}" class="{{ request()->is('*/qlkythi*') ? 'active' : '' }}">
              <i class="bi bi-circle"></i><span>Kỳ thi</span>
            </a>
          </li>
          <li>
            <a href="{{route('hoidongthi.qlcathi.danhsach')}}" class="{{ request()->is('*/qlcathi*') ? 'active' : '' }}">
              <i class="bi bi-circle"></i><span>Ca thi</span>
            </a>
          </li>
          <li>
            <a href="{{route('hoidongthi.qlphongthi.danhsach')}}" class="{{ request()->is('*/qlphongthi*') ? 'active' : '' }}">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{route('hoidongthi.qldethi.danhsach')}}" class="{{ request()->is('*/qldethi*') ? 'active' : '' }}">
