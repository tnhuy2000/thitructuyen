...
<div class="pagetitle">
  ...
  <nav>
	<ol class="breadcrumb">
	  ...
	  <li class="breadcrumb-item active">{{$cathi}}</li>
	</ol>
  </nav>
</div><!-- End Page Title -->
...
<section class="section">
  <div class="row">
	<div class="col-lg-12">
	  ...
	  <div class="card">
		<div class="card-body">
		  	<h5 class="card-title">Dữ liệu bài thi ngày: {{$ngaythi}} | Ca thi: {{$cathi}}</h5>
		  ...
		  <table class="table datatable table-hover">
			...
			<tbody>
				...
				<tr>
                    ...
                    <td><i class="bx bxs-folder text-warning"></i> {{$ngaythi}}/{{$cathi}}/{{$fileInfo->getFilename(), PHP_EOL}}</td>
                    <td><a href="{{route('admin.dethi_baithi.qlbaithi.zipPhongThi',['ngaythi' => $ngaythi,'cathi'=>$cathi,'phongthi'=>$fileInfo->getFilename()])}}"><i class="bx bxs-download"></i>Tải</a></td>
                    <td><a href=""><i class="bx bxs-folder-open text-warning"></i> Mở</a></td>
